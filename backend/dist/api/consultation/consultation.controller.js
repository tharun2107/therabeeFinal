...
exports.getAllConsultationsHandler = exports.createConsultationHandler = void 0;
const consultationService = __importStar(require("./consultation.service"));
const createConsultationHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const consultation = yield consultationService.createConsultation(req.body);
        res.status(201).json({
...
exports.createConsultationHandler = createConsultationHandler;
const getAllConsultationsHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const consultations = yield consultationService.getAllConsultations();
